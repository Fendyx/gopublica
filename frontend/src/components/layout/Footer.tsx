      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            <Link to="/" className="footer-logo">GoPublica</Link>
          ...
          <div className="footer-nav">
            ...
            <ul>
              ...
              {/* <li><Link to="/portfolio">{t('footer.links.portfolio')}</Link></li> */}
              <li><Link to="/pricing">{t('footer.links.pricing')}</Link></li>
              {/* <li><Link to="/calculator">{t('footer.links.calculator')}</Link></li> */}
            </ul>
          </div>
          ...
          <div className="footer-contacts">
            <h4 className="footer-title">{t('footer.contacts.title')}</h4>
            <p>{t('footer.contacts.email')}</p>
            <p>{t('footer.contacts.location')}</p>
        ...
        <div className="footer-bottom">
          <p>&copy; {currentYear} GoPublica. {t('footer.rights')}</p>
        </div>
      </div>
    </footer>
  );
