...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}/${locale}/legal/services`,
      languages: {
        en: `${baseUrl}/en/legal/services`,
        de: `${baseUrl}/de/legal/services`,
        pl: `${baseUrl}/pl/legal/services`,
        ru: `${baseUrl}/ru/legal/services`,
        ua: `${baseUrl}/ua/legal/services`,
        es: `${baseUrl}/es/legal/services`,
      },
    },
    openGraph: {
      title: 'Our Services – GoPublica',
      description: 'GoPublica offers comprehensive SaaS solutions for restaurants, beauty salons, auto service shops, and e-commerce stores.',
      url: `${baseUrl}/${locale}/legal/services`,
      siteName: 'GoPublica',
      locale,
      type: 'website',
    },
...
export default async function ServicesPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const jsonLd = {
    ...
    url: 'https://gopublica.com/legal/services',
    about: {
      '@type': 'Organization',
      name: 'GoPublica',
